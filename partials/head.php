...
<?php endif; ?>
    ...
    <!-- Slick -->
    <link type="text/css" rel="stylesheet" href="<?php echo baseURL(auto_version('/assets/css/slick.css')); ?>"/>
    <link type="text/css" rel="stylesheet" href="<?php echo baseURL(auto_version('/assets/css/slick-theme.css')); ?>"/>
    <!-- nouislider -->
