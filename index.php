<?php
  ...
  include "./partials/func/functions.php";
?>
<!DOCTYPE html>
<html>
<?php 
...
<?php while ($rowcateg = $categ->fetchArray(SQLITE3_ASSOC)) { ?>
        <div class="categ-card">
          ...
          <div class="categ-label">
            ...
            <a href="/pages/<?php echo $rowcateg["kateg"]?>.php" class="categ-btn">Lihat Disini <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
<?php }?>
      </section>
